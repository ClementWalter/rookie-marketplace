...
| `boundary_final` | Last only | Lagrange L_{n-1} |
...
- Total constraints reviewed: ___
- Columns verified constrained: ___/___
- Degree budget used: ___/___
- Global arguments verified: ___/___
- Adversarial tests passed: ___/6
